...
This document provides detailed instructions for developing and publishing the `argparse-ps1-wrapper` package.
...
python -m pytest --cov=argparse_ps1_wrapper --cov-report=html

# Run specific test
python -m pytest tests/test_argparse_ps1_wrapper.py::test_import -v
```
...
1. **Package Names**: First-come, first-served basis
   ...
   - Once you register `argparse-ps1-wrapper`, no one else can use this exact name
...
6. **Test installation from TestPyPI**:
   ...
   **Using pip (traditional method):**
   ...
   pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ argparse-ps1-wrapper
...
python -c "
import requests
resp = requests.get('https://pypi.org/pypi/argparse-ps1-wrapper/json')
...
python -c "import argparse_ps1_wrapper; print(argparse_ps1_wrapper.__file__)"
